...
document.addEventListener('DOMContentLoaded', () => {
	...
	const showcaseData = {
		list: {
			...
			caption:
				'List View: Organized into Morning, Afternoon, Evening, and Anytime routines.',
		},
		grid: {
			light: './assets/screenshots/grid-view-light.png',
			dark: './assets/screenshots/grid-view-dark.png',
			caption:
				'Grid View: Compact visual layout to see all your habits at a quick glance.',
		},
		card: {
			light: './assets/screenshots/card-view-light.png',
			dark: './assets/screenshots/card-view-dark.png',
			caption:
				'Card View: Rich habit cards featuring live timers, streak counts, and details.',
		},
		detail: {
			light: './assets/screenshots/habit-detail-light.png',
			dark: './assets/screenshots/habit-detail-dark.png',
			caption:
				'Habit Detail: Daily completion calendar, history, and streak progress.',
		},
	}
	...
	function applyTheme(theme) {
		...
		if (heroCenterImg) {
			heroCenterImg.src =
				theme === 'dark'
					? './assets/screenshots/card-view-dark.png'
					: './assets/screenshots/card-view-light.png'
		}
		if (heroLeftImg) {
			heroLeftImg.src =
				theme === 'dark'
					? './assets/screenshots/home-page-dark.png'
					: './assets/screenshots/home-page-light.png'
		}
		if (heroRightImg) {
			heroRightImg.src =
				theme === 'dark'
					? './assets/screenshots/grid-view-dark.png'
					: './assets/screenshots/grid-view-light.png'
		}
		...
		function animateSnippets() {
			...
			snippets.forEach((snippet) => {
				const factor = parseFloat(
					snippet.getAttribute('data-parallax') || '0.03'
				)
